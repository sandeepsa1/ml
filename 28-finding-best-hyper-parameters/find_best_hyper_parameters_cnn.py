...
# For below configuration, execution time in colab : 3 hours
epochs = 2
lrs = [1e-4, 1e-3, 1e-2, 5e-2, 1e-1, 2e-1, 5e-1]
mini_batch_sizes = [64, 128]
hidden_layer_nodes = [ [16, 16], [32, 32], [16, 16, 16], [16, 32, 32], [16, 32, 32, 64] ]
