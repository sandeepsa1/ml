## Finding the optimal learning rate range and thereby finding the most optimal learning rate
Finding the optimal learning rate range is crucial for effectively training neural networks.</br>
...
4. Run the Python scripts as mentioned below.
   ...
   1. Run the above method again with a shorter range of learning rate or more number of epochs, if required to find the best learning rate.
   1. Then run the train_model method using the best learning range.
